...
public class Client : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Pacchetto.Inizialize_Packet(D, false, settings, lobby,"Client");
    }
    ...
    void FirstContact()
    {
        ...
        try
        {
            Mex = Pacchetto.First_Contact(2, false).ToString();
            if (D) Debug.Log("inizio primo contatto con " + (IPEndPoint)Servente.RemoteEndPoint + "risultato first contact: " + Mex);
            ...
            if (Pacchetto.Get_Header())
            {
                ...
                {
                    Mex = Pacchetto.First_Contact(1, true).ToString();
                    switch(Mex)
                    {
                        case "3":
                        ...
                        case "4":
                            ...
                            break;
                        default:
                            settings.Error_Profiler("N015", 0, "(Client)Codice First contact errato => Codice ricevuto:" + Mex, 2, false);
